...
- After `015`, can you clean a messy drive log, skip bad rows, replay it, and write JSON?
- After `009`, can you step a pose from a twist without changing the values you were given?
- After `027`, can you zero a command when the last good scan is too old, then integrate one odometry step?
