...
Complete the exercises in `1.6_python_practice/` before the capstone task, in the order listed in the Python for Robotics section. Each exercise has a spec and assertions — run them to check your work.
